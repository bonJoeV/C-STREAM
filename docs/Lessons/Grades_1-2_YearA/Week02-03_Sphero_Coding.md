---
title: "Weeks 2-3: Sphero Coding Adventures"
description: "Grades 1-2 introduction to coding with Sphero robots"
version: "1.0"
date: 2025-12-05
tags:
  - grades-1-2
...
1. Use Sphero Edu app to code basic movements (forward, back, turn)
2. Create a simple sequence of at least 3 commands
3. Use a loop to repeat actions
4. Debug programs that don't work as expected

### Faith Integration Objectives
Students will be able to:
1. Understand that robots follow instructions from humans
2. Connect purposeful programming to using our gifts wisely
3. Practice patience and perseverance in coding
...
**Block Mode basics:**
1. **Roll block** — makes Sphero move
2. **Delay** — makes Sphero wait
3. **Turn** — changes direction
4. **Loop** — repeats commands

**Create a simple program together:**
1. Roll forward 1 second
2. Wait 1 second
3. Roll backward 1 second
...
**Challenge 1: Make Sphero move forward and stop**
**Challenge 2: Make Sphero move forward, then backward**
**Challenge 3: Make Sphero move in a square pattern**
...
**Example:**
Without loop: Roll forward, turn right, roll forward, turn right, roll forward, turn right, roll forward, turn right (makes a square)
