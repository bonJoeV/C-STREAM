---
title: "Week 16: Star of Wonder"
description: "Kindergarten astronomy and navigation lesson connected to the Christmas story"
version: "1.0"
date: 2025-12-05
tags:
  - kindergarten
...
1. Understand that stars are in the sky and can be seen at night
2. Identify that stars make patterns (introduce constellations)
3. Connect a line of dots/stars to make a simple pattern
4. Create a star art project

### Faith Integration Objectives
Students will be able to:
1. Retell the story of the Magi following the star to Jesus
2. Understand that God used a star to lead people to Jesus
3. Wonder at God's creation of the night sky
...
**Instructions:**
1. Use star stickers to put stars all over your sky
2. Make one BIG star — the Star of Bethlehem
3. Use white crayon to draw the stable or the Wise Men following the star (optional)
4. Add glitter for sparkle (optional)
...
**Simplified version:**
1. Prayer about stars
2. Tell the story of the Wise Men following the star
3. Make star art with stickers on dark paper
4. Share pictures
5. Closing prayer
