---
title: "Week 11: Coding Thankfulness"
description: "Kindergarten Thanksgiving coding lesson with ScratchJr"
version: "1.0"
date: 2025-12-05
tags:
  - kindergarten
...
1. Open and navigate ScratchJr on an iPad
2. Add a character (sprite) to a project
3. Use the "move" block to make a character move
4. Connect coding to expressing gratitude

### Faith Integration Objectives
Students will be able to:
1. Express thankfulness to God
2. Understand that we can use technology to share our gratitude
3. Create something that shows what they're thankful for
...
**Instructions:**
> "Your job:
> 1. Add a character that shows something you're thankful for
> 2. Make it MOVE!"
...
**Save and Close:**
Show students how to save their project (it auto-saves), then close iPads.
...
**No-tech backup plan:**
1. Discuss what we're thankful for
2. Draw a picture of something you're thankful for
3. Add "motion lines" to show movement
4. Share drawings with partners
