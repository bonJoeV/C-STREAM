---
title: "Weeks 5-6: Building with KEVA Planks"
description: "Kindergarten introduction to engineering and building structures"
version: "1.2"
date: 2025-12-05
tags:
  - kindergarten
...
1. Build a tower using KEVA planks that stands on its own
2. Identify why some structures fall and others stand (balance, foundation)
3. Count the planks used in their structure
4. Rebuild after failure (engineering design process)

### Faith Integration Objectives
Students will be able to:
1. Understand that God wants us to use our talents to build good things
2. Practice patience and perseverance when building is challenging
3. Connect building to helping others (building homes, churches, schools)
...
**Establish building rules:**
1. Build on your mat
2. Use gentle hands — no throwing
3. If your structure falls, that's okay! Say "Oops!" and rebuild
4. Clean up all planks at the end
...
**Countdown test:**
When a student thinks they're done, count to 10 together:
...
**Simplified Plan:**
1. Opening prayer
2. Free building for 15 minutes
3. Gallery walk to see everyone's work
4. Count planks together
5. Closing prayer
