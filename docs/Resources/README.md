---
title: "C-STREAM Resources"
description: "Supporting resources for teachers, parents, and substitutes"
---
...
### [Catholic Scientists Heritage](./Catholic_Scientists_Heritage.md)
...
### [Teacher Self-Evaluation](./Teacher_Self_Evaluation.md)
...
### [Wonder and Curiosity Guide](./Wonder_Curiosity_Guide.md)
...
### [Parent Communication Guide](./Parent_Communication_Guide.md)
...
### [Weekly Parent Sheet Template](./Weekly_Parent_Sheet_Template.md)
...
### [Substitute Teacher Guide](./Substitute_Teacher_Guide.md)
...
### [CSCOE Library Planning Guide](./CSCOE_Library_Planning_Guide.md)
...
### [Liturgical Calendar Integration](./Liturgical_Calendar_Integration.md)
...
### [Budget Request Templates](./Budget_Request_Templates.md)
...
### [STREAM Night Guide](./STREAM_Night_Guide.md)
...
|-------------------|-------------------|
| **Getting started quickly** | [Quick Start Guide](./Quick_Start_Guide.md) |
| Highlight Catholic scientists | [Catholic Scientists Heritage](./Catholic_Scientists_Heritage.md) |
| Evaluate your teaching | [Teacher Self-Evaluation](./Teacher_Self_Evaluation.md) |
| Make lessons wonder-filled | [Wonder and Curiosity Guide](./Wonder_Curiosity_Guide.md) |
| Communicate with parents | [Parent Communication Guide](./Parent_Communication_Guide.md) |
| Weekly take-home sheets | [Weekly Parent Sheet Template](./Weekly_Parent_Sheet_Template.md) |
| Prepare for absences | [Substitute Teacher Guide](./Substitute_Teacher_Guide.md) |
| Request CSCOE materials | [CSCOE Library Planning Guide](./CSCOE_Library_Planning_Guide.md) |
| **Track student progress** | [Student Progress Tracker](./Student_Progress_Tracker.md) |
| **Support diverse learners** | [Differentiation Guide](./Differentiation_Guide.md) |
| **Find answers to common questions** | [FAQ & Troubleshooting](./FAQ_Troubleshooting.md) |
| **Purchase/inventory supplies** | [Materials Inventory Checklist](./Materials_Inventory_Checklist.md) |
| **Connect to liturgical year** | [Liturgical Calendar Integration](./Liturgical_Calendar_Integration.md) |
| **Request program funding** | [Budget Request Templates](./Budget_Request_Templates.md) |
| **Train parent volunteers** | [Volunteer Guide](./Volunteer_Guide.md) |
| **Plan family STREAM events** | [STREAM Night Guide](./STREAM_Night_Guide.md) |

---

## 📝 Student Resources

Printable worksheets for students are available in the [Student Resources](../Student_Resources/README.md) folder:
