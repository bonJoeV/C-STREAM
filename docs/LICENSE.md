---
title: "License & Use Policy"
description: "Terms of use for the C-STREAM Framework"
---
...
<div style="display: flex; align-items: flex-start; margin: 20px 0;">
  ...
  <div style="max-width: 600px;">
    <h1 style="margin-top: 0;">📜 License & Use Policy</h1>
    <p><strong>C-STREAM Framework</strong> – Catholic Science, Technology, Religion, Engineering, Arts, and Math</p>
  </div>
</div>
...
If you wish to use these materials for commercial purposes, please [contact me](mailto:joe@olp.school) to discuss licensing options. I'm open to partnerships that advance Catholic STEM education.
...
3. Your contribution aligns with Catholic values and teachings
...
- **GitHub Issues**: [Open an issue](https://github.com/bonJoeV/C-STREAM/issues)
...
The full text of the CC BY-NC-SA 4.0 license is available at:
