---
title: "Contributing to C-STREAM"
description: "Guidelines for contributing to the C-STREAM Framework"
---
...
3. Provide a clear description with as much detail as possible:
...
3. **Use Our Templates**  
   Build your lesson using the [C-STREAM Lesson Plan Template](./Templates/Lesson_Plan_Template.md). Ensure your lesson:
...
Help expand our [Catholic Scientists Heritage](./Resources/Catholic_Scientists_Heritage.md) resource:

1. Research a Catholic scientist not yet profiled
2. Include:
...
Ensure contributions align with the [12 Success Factors](index.md) for Catholic STEM education.
...
1. **Initial Review** - The C-STREAM team reviews your contribution
2. **Feedback** - You may receive suggestions for improvements
3. **Revision** - Update your pull request based on feedback
4. **Merge** - Approved contributions are merged into the main branch
